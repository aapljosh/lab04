...
-- Date:              Thu Apr 10 11:22:27 2014 (by Create and Import Peripheral Wizard)
...
begin
  ...
  begin
    ...
    case slv_reg_read_sel is
      when "10000000" => slv_ip2bus_data <= slv_reg0(C_SLV_DWIDTH-1 downto 0);--8) & SWITCHES;
      when "01000000" => slv_ip2bus_data <= slv_reg1(C_SLV_DWIDTH-1 downto 0);--8) & SWITCHES;
      when "00100000" => slv_ip2bus_data <= slv_reg2(C_SLV_DWIDTH-1 downto 0);--8) & SWITCHES;
      when "00010000" => slv_ip2bus_data <= slv_reg3(C_SLV_DWIDTH-1 downto 0);--8) & SWITCHES;
      when "00001000" => slv_ip2bus_data <= slv_reg4(C_SLV_DWIDTH-1 downto 0);--8) & SWITCHES;
      when "00000100" => slv_ip2bus_data <= slv_reg5(C_SLV_DWIDTH-1 downto 0);--8) & SWITCHES;
      when "00000010" => slv_ip2bus_data <= slv_reg6(C_SLV_DWIDTH-1 downto 0);--8) & SWITCHES;
      when "00000001" => slv_ip2bus_data <= slv_reg7(C_SLV_DWIDTH-1 downto 0);--8) & SWITCHES;
